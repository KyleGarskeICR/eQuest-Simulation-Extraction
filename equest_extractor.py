...
@@ -556,297 +573,393 @@ def _set_numeric_cell(row: ET.Element, cell_ref: str, value: float | None, style
...
@@ -1071,147 +1184,362 @@ def extract_ps_h_details(sim_text: str) -> Dict[str, object]:
                pumps[report_name] = {
                    "attached_to": row[0],
                    "flow": float(row[1]),
                    "head": float(row[2]),
